...
class RNN(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers,output_size):
        ...
        self.gru = nn.GRU(input_size,hidden_size, num_layers,batch_first=True) #feature為input_size(也就是所有的字元數量),hidden_size=128
    ...
    def forward(self, input):
        ...
        output,next_hidden = self.gru(input,init_hidden)
