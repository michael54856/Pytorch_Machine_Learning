...
class RNN(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers,output_size):
        ...
        self.lstm = nn.LSTM(input_size,hidden_size, num_layers,batch_first=True) #feature為input_size(也就是所有的字元數量),hidden_size=128
    ...
    def forward(self, input):
        ...
        init_cell = torch.zeros(self.num_layers, input.size(0),self.hidden_size) #多了一個cell state
        output,next_hidden = self.lstm(input,(init_hidden,init_cell))
